...
- [ ] **Step 1: Replace the outer bar markup**
...
- [ ] **Step 2: Replace obsolete bar CSS with menu-bar CSS**
...
- [ ] **Step 3: Reduce the app-switcher width**
...
- [ ] **Step 2: Verify desktop and mobile in Chromium**
