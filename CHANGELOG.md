...
- Simplify the public footer so it no longer downloads raw project Markdown files.

### Fixed

- Match visible keyboard prompts, animation transitions, and menu-bar state to the exact app or window being selected.
- Keep the demo readable at 320px without clipping, stretching, or oversized overlays.
