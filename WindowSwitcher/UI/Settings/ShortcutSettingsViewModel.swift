...
public extension Notification.Name {
    static let shortcutSettingsDidChange = Notification.Name("WindowSwitcher.shortcutSettingsDidChange")
    static let shortcutRegistrationDidChange = Notification.Name("WindowSwitcher.shortcutRegistrationDidChange")
    static let shortcutRecordingDidBegin = Notification.Name("WindowSwitcher.shortcutRecordingDidBegin")
    static let shortcutRecordingDidEnd = Notification.Name("WindowSwitcher.shortcutRecordingDidEnd")
}
