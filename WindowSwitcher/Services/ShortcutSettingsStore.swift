...
public struct ShortcutSettingsStore {
    private static let windowShortcutStorageKey = "WindowSwitcher.shortcut.currentAppWindowSwitching"
    private static let registrationMessagesKey = "WindowSwitcher.shortcut.registrationMessages"
