# Research: macOS SwitchTab

> Current repository note (2026-07-12): this research file preserves earlier
> design exploration, including app-level switching and drag-overlay permission
> recovery. The checked-in app currently ships current-app window switching,
> text/button System Settings recovery, and no System Settings locator or
...
## Historical Decision: Use NSWorkspace and NSRunningApplication for app inventory and activation
...
## Historical Decision: Activate selected applications with foreground activation options
...
## Historical Decision: Use one icon-strip app switcher with release confirmation
...
## Historical Decision: Use a user-driven drag overlay for privacy recovery
...
## Historical Decision: Locate System Settings with CoreGraphics window metadata
...
## Historical Decision: Keep permission panel placement deterministic and testable
...
## Historical Decision: Use bounded lookup instead of continuous polling
...
## Historical Decision: Share one overlay implementation across Accessibility and Screen Recording
